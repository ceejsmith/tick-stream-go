...
func TestParse(t *testing.T) {
    ticks := Parse(lines)
    checkLine("AA", []int { 2016, 1, 27, 9, 30, 1 }, 7.07, 500, ticks[0], t)
    checkLine("AA", []int { 2016, 1, 27, 9, 30, 9 }, 7.06, 100, ticks[1], t)
    checkLine("AA", []int { 2016, 1, 27, 9, 31, 0 }, 7.05, 100, ticks[2], t)
}
